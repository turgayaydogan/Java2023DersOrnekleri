...
public class dosyaOkumaYazma_3_1 {
    ...
    public static void main(String[] args) {
        try {
            ...
            for (String satir : stringList) {// satır satır okuma işlemi yapılıyor
                ...
                BigDecimal yuvarlanacakDeger = BigDecimal.valueOf(ort);
                BigDecimal yuvarlananDeger = yuvarlanacakDeger.setScale(2, RoundingMode.HALF_UP);// 5 den yukarı yuvarlar

                System.out.println("Vize: "+satirBilgileri[5]+", Final: "+satirBilgileri[6]+" = Ortalama: "+yuvarlananDeger);
